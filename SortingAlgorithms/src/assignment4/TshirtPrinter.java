...
public class TshirtPrinter  {
    ...
    //======= Print with BubbleSort Method =========//
     public void bubbleSortBySize(int TshirtsNumber, int order) {
        ...
        if (order == 0) {
             System.out.println("\nTshirts bubblesort[ASC] by Size\n");
        }
        else if (order == 1){
        System.out.println("\nTshirts bubblesort[DESC] by Size\n");
        }
    ...
    public void bubbleSortByColor(int TshirtsNumber, int order) {
        ...
        if (order == 0) {
             System.out.println("\nTshirts bubblesort[ASC] by Color\n");
        }
        else if (order == 1){
        System.out.println("\nTshirts bubblesort[DESC] by Color\n");
        }
    ...
    public void bubbleSortByFabric(int TshirtsNumber, int order) {
        ...
        if (order == 0) {
             System.out.println("\nTshirts bubblesort[ASC] by Fabric\n");
        }
        else if (order == 1){
        System.out.println("\nTshirts bubblesort[DESC] by Fabric\n");
        }
        printTshirtsFabric(tshirts);
    }

    //=============================================// 
    //======== Print with QuickSort Method ========//    
    public void quickSortBySize(int TshirtsNumber, int order) {
        ...
        if (order == 0) {
             System.out.println("\nTshirts quickSort[ASC] by Size\n");
        }
        else if (order == 1){
        System.out.println("\nTshirts quickSort[DESC] by Size\n");
        }
        printTshirtsSize(tshirts);
    }
    ...
    public void quickSortByColor(int TshirtsNumber, int order) {
        ...
        if (order == 0) {
             System.out.println("\nTshirts QuickSort[ASC] by Color\n");
        }
        else if (order == 1){
        System.out.println("\nTshirts QuickSort[DESC] by Color\n");
        }
        printTshirtsColor(tshirts);
    }
    ...
    public void quickSortByFabric(int TshirtsNumber, int order) {
        ...
        if (order == 0) {
             System.out.println("\nTshirts QuickSort[ASC] by Fabric\n");
        }
        else if (order == 1){
        System.out.println("\nTshirts QuickSort[DESC] by Fabric\n");
        }
        printTshirtsFabric(tshirts);
    }

    //==============================================//
    //======== Print with BucketSort Method ========//    
    public void bucketSortBySize(int TshirtsNumber, int order, int buckets) {
        ...
        if (order == 0) {
             System.out.println("\nTshirts BucketSort[ASC] by Size\n");
        }
        else if (order == 1){
        System.out.println("\nTshirts BucketSort[DESC] by Size\n");
        }
        printTshirtsSize(tshirts);
    ...
    public void bucketSortByColor(int TshirtsNumber, int order, int buckets) {
        ...
        if (order == 0) {
             System.out.println("\nTshirts BucketSort[ASC] by Color\n");
        }
        else if (order == 1){
        System.out.println("\nTshirts BucketSort[DESC] by Color\n");
        }
        printTshirtsColor(tshirts);
    }
    ...
    public void bucketSortByFabric(int TshirtsNumber, int order, int buckets) {
        ...
        if (order == 0) {
             System.out.println("\nTshirts BucketSort[ASC] by Fabric\n");
        }
        else if (order == 1){
        System.out.println("\nTshirts BucketSort[DESC] by Fabric\n");
        }
        printTshirtsFabric(tshirts);
    }
}
